...
import customPatchesStickers from "./discoveries/custom-patches-stickers.json";
...
const discoveriesBySlug: Record<DiscoverySlug, Discovery> = {
  ...
  "custom-patches-stickers": customPatchesStickers as Discovery,
};
